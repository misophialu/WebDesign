...
var removeItem_btn = document.getElementById('removeItem_btn');
...
removeItem_btn.addEventListener('click', removeItemByIndex)
...
function addItem(event){
	...
	//create the input box and label using innerHTML
